...
function Swiss20({
  ...
  useEffect(() => {
    const updateData = () => {
      setNewMatchups(() => {
        return swiss20Data.map((matchup) => ({
      ...
      const teamsToSet = teamData.filter(
        (team) => team.record.wins === 2 && team.record.losses === 0
      );

      setSelectableTeams(teamsToSet);
    };
    updateData();
  }, [swiss20Data, teamData]);
      ...
      <thead>
        <tr>
          <th colSpan="3" style={{ textAlign: "center" }}>
            <h2 className="round-name">Round 2-0</h2>
          </th>
        </tr>
        <tr>
          ...
          <tfoot>
            <tr>
              <td colSpan="3" style={{ textAlign: "center" }}>
                <button
                  onClick={() => {
                    updateMatchups(newMatchups, "Swiss", "2-0");
                    updateWinner(newMatchups, "Swiss", "2-0", "playoffs");
                  }}
                >
                  Update
                </button>
