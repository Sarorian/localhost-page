...
function CO3rdPlace({
  ...
  useEffect(() => {
    const updateData = () => {
      setNewMatchups(() => {
        return CO3rdPlaceData.map((matchup) => ({
      ...
      const teamsToSet = teamData.filter((team) => team.stage === "CO3rdPlace");

      setSelectableTeams(teamsToSet);
    };
    updateData();
  }, [CO3rdPlaceData, teamData]);
  ...
  return (
    <table className="bracket-table">
      <thead>
        <tr>
          <th colSpan="3" style={{ textAlign: "center" }}>
            <h2 className="round-name">3rd Place Match</h2>
          </th>
        </tr>
        <tr>
      ...
      <tbody>
        {CO3rdPlaceData &&
          CO3rdPlaceData.map((matchup, index) => (
          ...
          <tfoot>
            <tr>
              <td colSpan="3" style={{ textAlign: "center" }}>
                <button
                  onClick={() => {
                    updateMatchups(newMatchups, "Consolation", "3rdPlace");
                    updateWinner(
                      newMatchups,
                      "Consolation",
                      "3rdPlace",
