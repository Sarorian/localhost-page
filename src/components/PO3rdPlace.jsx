...
function PO3rdPlace({
  ...
  useEffect(() => {
    const updateData = () => {
      setNewMatchups(() => {
        return PO3rdPlaceData.map((matchup) => ({
      ...
      const teamsToSet = teamData.filter((team) => team.stage === "3rdPlace");

      setSelectableTeams(teamsToSet);
    };
    updateData();
  }, [PO3rdPlaceData, teamData]);
          ...
          <tfoot>
            <tr>
              <td colSpan="3" style={{ textAlign: "center" }}>
                <button
                  onClick={() => {
                    updateMatchups(newMatchups, "Playoff", "3rdPlace");
                    updateWinner(
                      newMatchups,
                      "Playoff",
                      "3rdPlace",
