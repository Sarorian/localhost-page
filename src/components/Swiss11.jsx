...
function Swiss11({
  ...
  useEffect(() => {
    const updateData = () => {
      setNewMatchups(() => {
        return swiss11Data.map((matchup) => ({
      ...
      const teamsToSet = teamData.filter(
        (team) => team.record.wins === 1 && team.record.losses === 1
      );

      setSelectableTeams(teamsToSet);
    };
    updateData();
  }, [swiss11Data, teamData]);
      ...
      <thead>
        <tr>
          <th colSpan="3" style={{ textAlign: "center" }}>
            <h2 className="round-name">Round 1-1</h2>
          </th>
        </tr>
        <tr>
          ...
          <tfoot>
            <tr>
              <td colSpan="3" style={{ textAlign: "center" }}>
                <button
                  onClick={() => {
                    updateMatchups(newMatchups, "Swiss", "1-1");
                    updateWinner(newMatchups, "Swiss", "1-1");
                  }}
                >
                  Update
                </button>
